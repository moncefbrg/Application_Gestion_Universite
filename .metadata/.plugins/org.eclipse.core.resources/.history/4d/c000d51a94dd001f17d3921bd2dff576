...
public interface IServiceCollecteNotes {
	File genererFichierCollecteNotes(String session, String niveau, String module) throws Exception; //genere un fichier excel pour la collecte de notes pour module
